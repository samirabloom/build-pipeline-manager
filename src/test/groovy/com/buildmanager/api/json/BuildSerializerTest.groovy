 ...
 * @author jamesdbloom
 */
class BuildSerializerTest extends Specification {
    ...
    void 'should serialize \'#test\''() throws IOException {
        ...
        where:
            ...
            new Build()
                    ...
                    .setUpdatedDate(new DateTime("2014-12-15T18:29:16.965Z")) | 'minimal object' || "" +
                    "{" + NEW_LINE +
            ...
            new Build()
                    ...
                    .setUpdatedDate(new DateTime("2014-12-14T18:52:02.043Z")) | 'full object'    || "" +
                    "{" + NEW_LINE +
