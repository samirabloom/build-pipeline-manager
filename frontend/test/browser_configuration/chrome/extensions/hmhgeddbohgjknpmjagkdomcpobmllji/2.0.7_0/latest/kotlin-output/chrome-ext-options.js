Kotlin.defineModule('chrome-ext-options', ['jb-chrome-ext-api', 'browser-ext-platform'], function () {
  ...
  Kotlin.p(_, 'com_jetbrains_browserConnection_chrome_options', function () {
    function $f0(callback, it) {
      callback(it !== null && it !== undefined ? it : _.com_jetbrains_browserConnection_chrome_options.Settings(Kotlin.modules['browser-ext-platform'].com_jetbrains_browserConnection.DEFAULT_JB_HOST, Kotlin.modules['browser-ext-platform'].com_jetbrains_browserConnection.DEFAULT_JB_PORT, null, true));
    }
    ...
    Settings: {value: (function () {
      return Kotlin.createClass(null, function (host, port, corsUrl, appendSourceUrl) {
        ...
        Object.defineProperty(this, 'appendSourceUrl', {value: appendSourceUrl, enumerable: true});
      });
    })()}
  });
  Kotlin.finalize(_);
