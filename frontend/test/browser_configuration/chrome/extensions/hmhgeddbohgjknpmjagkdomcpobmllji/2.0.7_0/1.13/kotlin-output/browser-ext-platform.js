Kotlin.defineModule('browser-ext-platform', null, function () {
  ...
  Kotlin.p(_, 'org_jetbrains_browserConnection', null, /** @lends _.org_jetbrains_browserConnection */ {
    TabService: {value: (function () {
      return Kotlin.createTrait(null, /** @lends _.org_jetbrains_browserConnection.TabService.prototype */ {
        ...
        load: {value: function (url, uriToOpen, existingTab, newTab, focusWindow, callback) {
          ...
          if (existingTab === null || existingTab === undefined) {
            if (newTab === null || newTab === undefined) {
              ...
              this.updateTab(newTab, normalizedUriToOpen, focusWindow, callback);
            }
          }
           else {
            this.updateTab(existingTab, uriToOpen, focusWindow, callback);
          }
        }, writable: true}
      });
    })()}
  ...
  Kotlin.p(_, 'org_jetbrains_util', function () {
    ...
    Object.defineProperty(this, 'disposer', {value: (function () {
      function $f0(dispose) {
        return (function () {
          return Kotlin.createObject(_.org_jetbrains_util.Disposable, null, {
            dispose: {value: function () {
  ...
  Kotlin.p(_, 'com_jetbrains_browserConnection', function () {
    Object.defineProperty(this, 'SelectorSubjects', {value: (function () {
      return Kotlin.createObject(null, function () {
    ...
    DomService: {value: (function () {
      ...
      function $f1(sourceUrls, rulesetLine, name, value, onlyExisting, it) {
        it.setCssProperty(sourceUrls, rulesetLine, name, value, onlyExisting);
      }
      function $f2(selector, selectorSubjectOrdinal, value, it) {
        it.setOuterHtml(selector, _.com_jetbrains_browserConnection.SelectorSubjects.valueOf(selectorSubjectOrdinal), value);
      }
      function $f3(sourceUrls, source, it) {
        it.setStyleSheetText(sourceUrls, source);
      }
      function $f4(filename, source, it) {
        it.setScriptSource(filename, source);
      }
      function $f5(selector, it) {
        it.reloadPageIfContains(selector);
      }
      function $f6(sourceUrls, it) {
        it.reloadPageIfContainsStyleSheet(sourceUrls);
      }
      function $f7(filename, it) {
        it.reloadPageIfUseScript(filename);
      }
      function $f8(selector, selectorSubject, it) {
      ...
      return Kotlin.createClass(null, function (pageManager) {
        ...
        setCssProperty: {value: function (projectId, sourceUrls, rulesetLine, name, value, onlyExisting) {
          this.execute(projectId, $f1.bind(null, sourceUrls, rulesetLine, name, value, onlyExisting));
        }},
        setOuterHtml: {value: function (projectId, selector, selectorSubjectOrdinal, value) {
          this.execute(projectId, $f2.bind(null, selector, selectorSubjectOrdinal, value));
        }},
        setStyleSheetText: {value: function (projectId, sourceUrls, source) {
          this.execute(projectId, $f3.bind(null, sourceUrls, source));
        }},
        setScriptSource: {value: function (projectId, filename, source) {
          this.execute(projectId, $f4.bind(null, filename, source));
        }},
        reloadPagesContainingElement: {value: function (projectId, selector) {
          this.execute(projectId, $f5.bind(null, selector));
        }},
        reloadPagesContainingStyleSheet: {value: function (projectId, sourceUrls) {
          this.execute(projectId, $f6.bind(null, sourceUrls));
        }},
        reloadPagesContainingScript: {value: function (projectId, filename) {
          this.execute(projectId, $f7.bind(null, filename));
        }},
        reloadPages: {value: function () {
          this.pageManager.reload();
        }},
        openUrl: {value: function (url) {
          this.pageManager.getOrCreateTab(url, undefined, undefined, undefined);
        }},
        highlightElement: {value: function (projectId, selector, selectorSubjectOrdinal) {
          ...
          this.execute(projectId, $f8.bind(null, selector, selectorSubject));
        }},
  ...
  Kotlin.p(_, 'org_jetbrains_extensions', function () {
    Object.defineProperty(this, 'Extensions', {value: (function () {
      return Kotlin.createObject(null, function () {
  ...
  /** @name _.com_jetbrains_browserConnection */ 
  Kotlin.p(_, 'com_jetbrains_browserConnection', function () {
    Object.defineProperty(this, 'greaterOrEquals', {value: function ($receiver, baseline, build) {
      if ($receiver.baselineVersion < baseline) {
        return false;
      }
      var bn = $receiver.buildNumber;
      if (bn !== null && bn !== undefined && bn !== 0 && bn < build) {
        return false;
      }
      return true;
    }});
    ...
    DebuggerService: {value: (function () {
      function $f0(usePreliminaryPage, callback, done, errorCallback, it) {
        this.pageManager.attachDebugger(it, !usePreliminaryPage, this.wrapCallFinally(callback, done), this.wrapCallFinally(errorCallback, done));
      }
      function $f1(usePreliminaryPage, url, callback, errorCallback, done) {
        try {
          var urlToOpen = usePreliminaryPage ? "data:text/html;base64," + window.btoa("<!DOCTYPE html><title>Loading " + url + "</title>") : null;
          this.pageManager.getOrCreateTab(url, urlToOpen, false, $f0.bind(this, usePreliminaryPage, callback, done, errorCallback));
        }
        catch (e) {
          try {
      ...
      return Kotlin.createClass(null, function (pageManager) {
        ...
        attach: {value: function (url, usePreliminaryPage, callback, errorCallback) {
          this.queueProcessor.add($f1.bind(this, usePreliminaryPage, url, callback, errorCallback));
        }},
  ...
  /** @name _.org_jetbrains_util */ 
  Kotlin.p(_, 'org_jetbrains_util', function () {
    Object.defineProperty(this, 'ThreeState', {value: (function () {
      return Kotlin.createObject(null, function () {
